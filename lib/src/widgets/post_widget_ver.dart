...
class PostWidgetVer extends StatefulWidget {
  const PostWidgetVer({Key? key, required this.postData}) : super(key: key);
  final PostModel postData;

  @override
  State<PostWidgetVer> createState() => _PostWidgetVerState();
}
