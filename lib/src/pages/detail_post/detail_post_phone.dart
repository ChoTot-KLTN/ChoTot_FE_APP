...
class DetailPostPhone extends StatefulWidget {
  ...
  @override
  State<DetailPostPhone> createState() => _DetailPostPhoneState();
}
  ...
  getPostDetail() async {
    try {
      ...
      if (result.statusCode == 200) {
        ...
        var jsonResponse = PostPhoneModel.fromMap(data);
        setState(() {
          postPhoneModel = jsonResponse;
          isLoading = false;
        });
      } else {
        print("Lỗi 404 ");
            ...
            child: isLoading
                ...
                : Column(
                    children: [
                      ...
                      buildDetail(Icons.flag, "Hãng: ${postPhoneModel!.brand}"),
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ListView(
                ...
                shrinkWrap: true,
                children: [
                  buildItemChat("Điện thoại này còn không ạ?"),
                  SizedBox(
                    width: 5,
                  ),
                  buildItemChat("Tình trạng bảo hành như thế nào?"),
                  SizedBox(
                    width: 5,
                  ),
              ...
              children: [
                ...
                Expanded(
                  child: isLoading
                      ? Text("Địa chỉ")
                      : Text(
                          postPhoneModel!.address.detail +
                              ", " +
                              postPhoneModel!.address.village +
                              ", " +
                              postPhoneModel!.address.district +
                              ", " +
                              postPhoneModel!.address.province,
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                        ),
                ),
