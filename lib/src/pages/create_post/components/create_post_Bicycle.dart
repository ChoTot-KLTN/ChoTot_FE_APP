...
class CreatePostBicycleScreen extends StatefulWidget {
  const CreatePostBicycleScreen({Key? key}) : super(key: key);

  @override
  State<CreatePostBicycleScreen> createState() =>
      _CreatePostBicycleScreenState();
}

class _CreatePostBicycleScreenState extends State<CreatePostBicycleScreen> {
  bool isUse = false;
  bool isNew = false;
  ...
  String idProvince = "";
  String idDistrict = "";
  String brandbicycle = listBrandBicycle[0];
  String typeBicycle = listTypeBicycle[0];
  String engine = listEngine[0];
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      brandbicycle = value.toString();
                                    });
                                  },
                                  items: listBrandBicycle.map((e) {
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      typeBicycle = value.toString();
                                    });
                                  },
                                  items: listTypeBicycle.map((e) {
                                    return DropdownMenuItem(
                                      child: new Text(e),
                                      value: e,
                                    );
            ...
            onPressed: () async {
              if (_formkey.currentState!.validate() &&
                ...
                AddressModel address = AddressModel(
                    ...
                    district: district,
                    province: province);
                String statusBicycle = "Mới";
                if (isNew == true) {
                  statusBicycle = "Mới";
                } else {
                  statusBicycle = "Đã sử dụng";
                }
                PostElecticBicycleModelRequired requiredBody =
                ...
                var result = await PostRepository().createPostElecticBicycle(
                    onModel: 'PostBicycle',
                    title: titlePoster.text,
                    content: descriptionPoster.text,
                    image: arrImageURl,
                    postBycicleModel: requiredBody);
                Get.back();
