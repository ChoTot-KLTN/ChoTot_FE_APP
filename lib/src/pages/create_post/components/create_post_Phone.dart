...
class CreatePostPhoneScreen extends StatefulWidget {
  const CreatePostPhoneScreen({Key? key}) : super(key: key);

  @override
  State<CreatePostPhoneScreen> createState() => _CreatePostPhoneScreenState();
}

class _CreatePostPhoneScreenState extends State<CreatePostPhoneScreen> {
  bool isUse = false;
  bool isNew = false;
  ...
  String idProvince = "";
  String idDistrict = "";
  String brandPhone = listBrandPhone[0];
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      brandPhone = value.toString();
                                    });
                                  },
                                  items: listBrandPhone.map((e) {
            ...
            onPressed: () async {
              if (_formkey.currentState!.validate() &&
                ...
                AddressModel address = AddressModel(
                    ...
                    district: district,
                    province: province);
                String statusPhone = "Mới";
                if (isNew == true) {
                  statusPhone = "Mới";
                } else {
                  statusPhone = "Đã sử dụng";
                }
                PostPhoneModelRequired postPhoneModel = PostPhoneModelRequired(
                    address: address,
                    brand: brandPhone,
                    color: color.text,
                    ram: ram,
                ...
                var result = await PostRepository().createPostPhone(
                    onModel: "PostPhone",
