...
class _CreatePostBDSScreenState extends State<CreatePostBDSScreen> {
  ...
  String idProvince = "";
  String idDistrict = "";
  String typeHouse = listTypeHouse[0];
  String numRoom = numberOfRoom[0];
  String numBathRoom = numberOfRoom[0];
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          ...
                          validator: (value) {
                            if (value!.isEmpty) {
                              return "Mã căn không được bỏ trống";
                            }
                            return null;
                          },
                        ),
          ...
          ElevatedButton(
            onPressed: () async {
              if (_formkey.currentState!.validate() &&
                ...
                PostApartmentModelRequired postApartmentModelRequired =
