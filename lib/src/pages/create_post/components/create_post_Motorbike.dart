...
class CreatePostMotorbikeScreen extends StatefulWidget {
  ...
  @override
  State<CreatePostMotorbikeScreen> createState() =>
      _CreatePostMotorbikeScreenState();
}

class _CreatePostMotorbikeScreenState extends State<CreatePostMotorbikeScreen> {
  bool isUse = false;
  bool isNew = false;
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                child: DropdownButton(
                                  ...
                                  isExpanded: true,
                                  value: brandMotorbike,
                                  onChanged: (value) {
                                    setState(() {
                                      brandMotorbike = value.toString();
                                    });
                                  },
                                  items: listBrandMotorbike.map((e) {
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      typeMotorbike = value.toString();
                                    });
                                  },
                                  items: listTypeMotorbike.map((e) {
                                    return DropdownMenuItem(
                                      child: new Text(e),
                                      value: e,
                                    );
