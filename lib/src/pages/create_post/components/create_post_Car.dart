...
class CreatePostCarScreen extends StatefulWidget {
  const CreatePostCarScreen({Key? key}) : super(key: key);

  @override
  State<CreatePostCarScreen> createState() => _CreatePostCarScreenState();
}

class _CreatePostCarScreenState extends State<CreatePostCarScreen> {
  bool isUse = false; // bán
  bool isNew = false; // thuê
  TextEditingController numberOfSeat = TextEditingController();
  TextEditingController addressDetail = TextEditingController();
  TextEditingController color = TextEditingController();
  TextEditingController price = TextEditingController();
  TextEditingController numberOfKm = TextEditingController();
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      brandCar = value.toString();
                                    });
                                  },
                                  items: listBrandCar.map((e) {
                            ...
                            children: [
                              ...
                              Flexible(
                                ...
                                child: DropdownButton(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      gearBox = value.toString();
                                    });
                                  },
                                  items: carGearbox.map((e) {
                                    return DropdownMenuItem(
                                      child: new Text(e),
                                      value: e,
                                    );
            ...
            onPressed: () async {
              if (_formkey.currentState!.validate() &&
                ...
                AddressModel address = AddressModel(
                    ...
                    district: district,
                    province: province);
                String statusCar = "Mới";
                if (isNew == true) {
                  statusCar = "Mới";
                } else {
                  statusCar = "Đã sử dụng";
                }
                PostCarModelRequried postCarModel = PostCarModelRequried(
                    address: address,
                    brand: brandCar,
                    yearOfManufacture: int.parse(yearManufacture),
                    carGearbox: gearBox,
                    fuel: fuel,
                    numberOfSeat: int.parse(numberOfSeat.text),
                    color: color.text,
                    statusCar: statusCar,
                    numberOfKm: int.parse(numberOfKm.text),
                    price: int.parse(price.text));

                var result = await PostRepository().createPostCar(
                    onModel: "PostCar",
