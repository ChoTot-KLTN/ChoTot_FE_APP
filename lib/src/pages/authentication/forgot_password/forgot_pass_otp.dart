...
class PinCodeScreen extends StatefulWidget {
  ...
  PinCodeScreen({required this.emailCurrent});
...
class _PinCodeVerificationScreenState extends State<PinCodeScreen> {
                  ...
                  child: TextButton(
                    onPressed: () async {
                      ...
                      var status = await AuthenticationRepository()
                          .sendNewPasswordAPI(
                              email: widget.emailCurrent, otp: currentText);
                      print(widget.emailCurrent.toString() +
                      ...
                      if (status.statusCode == 200) {
                        ...
                        Get.snackbar(
                            "Lấy lại mật khẩu thất bại", "Lỗi tài khoản",
                            duration: Duration(seconds: 4),
                            margin: EdgeInsets.all(6),
                            backgroundColor: Color(0x80000000),
                            colorText: Colors.white,
